				...
				<tbody>
					<?php while($hasil = $query->fetch()): ?>
						<tr>
							...
							<td><a href="detail-user.php?id=<?php echo $hasil['id_user']; ?>"><span class="fa fa-eye"></span> Detail</a></td>
							<td><a href="edit-user.php?id=<?php echo $hasil['id_user']; ?>"><span class="fa fa-pencil"></span> Edit</a></td>
							<td><a href="delete-user.php?id=<?php echo $hasil['id_user']; ?>" class="red yaqin-hapus"><span class="fa fa-times"></span> Hapus</a></td>
						</tr>
					<?php endwhile; ?>
				</tbody>
			</table>
