...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		redirect_to('show-kriteria.php?status=sukses-baru');		
			...
			<?php endif; ?>			
				...
				<form action="add-kriteria.php" method="post">
					...
					<div class="field-wrap clearfix">					
						...
						<input type="number" name="bobot" value="<?= $bobot; ?>" step="0.01">
					</div>
					<div class="field-wrap clearfix">					
						<label>Urutan Order</label>
						<input type="number" name="urutan_order" value="<?= $urutan_order; ?>">
					</div>
					<div class="field-wrap clearfix">					
